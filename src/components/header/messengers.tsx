...
const Messengers = ({ className }: { className?: string }) => {
    return (
        <ul className={[style.messengers, className ?? ""].join(" ")}>
            ...
            <li className={style.messengersItem}>
                <Link target="blanc" href="https://www.facebook.com/" className={style.navItemLink}>
                    <svg
                        width="10"
                        height="18"
                        viewBox="0 0 10 18"
                        ...
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M9.18854 10.125L9.68846 6.86742H6.56272V4.75348C6.56272 3.86227 6.99936 2.99355 8.39928 2.99355H9.82029V0.220078C9.82029 0.220078 8.53076 0 7.29783 0C4.72369 0 3.04112 1.56023 3.04112 4.38469V6.86742H0.179749V10.125H3.04112V18H6.56272V10.125H9.18854Z"
                            fill="black"
                        />
                    </svg>
                </Link>
